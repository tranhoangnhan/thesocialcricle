                      ...
                      <tr>
                        ...
                        <td>
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" placeholder="{{$video->material_name}}" aria-label="Username" aria-describedby="addon-wrapping" >
                              </div>
...
<td>
    <button  wire:click.prevent='saveTitle({{$video['material_id']}})' class="btn btn-success">Cập nhật</button>
</td>                    </tr>
                      @endforeach
