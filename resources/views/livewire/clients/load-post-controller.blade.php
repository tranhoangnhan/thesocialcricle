        ...
        <div class="card lg:mx-0 uk-animation-slide-bottom-small"
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex space-x-4 lg:font-bold">
                    <button wire:click='upLike({{$post->post_id}})' class="flex items-center space-x-2">
                        ...
                        <div> {{ $post->reaction_like_count }} @if ($post->reaction>0)
                ...
                @if ($selectedPostId === $post->post_id)
                @foreach ($post->additionalComments as $comment)
                <div class="flex">
                    <div class="w-10 h-10 rounded-full relative flex-shrink-0">
                        <img src="{{ asset('clients/assets/images/avatars/avatar-1.jpg') }}" alt=""
                            class="absolute h-full rounded-full w-full">
                ...
                @endforeach
            @endif
            <button wire:click='moreComment({{ $post->post_id}})' class="hover:text-blue-600 hover:underline"> Xem thêm bình luận </button>
                <div class="bg-gray-100 rounded-full relative dark:bg-gray-800 border-t">
                    <form wire:submit.prevent="Insertcomment({{ $post->post_id }})">
