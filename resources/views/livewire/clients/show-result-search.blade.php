<div>
    ...
    <div class="main_content">
        <div class="mcontainer">
            <div class="lg:flex lg:flex-x-10">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button wire:click.prevent="category0" class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" value="0" aria-selected="true">Tất cả</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button wire:click.prevent="category1" class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" value="1" aria-selected="false">Bài viết</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button wire:click.prevent="category2" class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" value="2" aria-selected="false">Bạn bè</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button wire:click.prevent="category3" class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" value="3" aria-selected="false">Khoá học</button>
                    </li>
                </ul>
            </div>
            <div class="lg:flex lg:space-x-10 mt-3">
                @if (sizeof($course) > 0 && $category == 3)
                    <div class="lg:w-2/3 w-full">
                        <div uk-sticky="media @m ; offset:80 ; bottom : true" class="card">
                            ...
                            <div class="border-b flex items-center justify-between p-4">
                                <div>
                                    <h2 class="text-lg font-semibold">Khoá học theo từ khoá</h2>
                                </div>
                                <a href="/courses" class="text-blue-500"> Xem thêm </a>
                            </div>
                                    ...
                                    <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                        <div class="flex-1">
                                            ...
                                            <a href="/courses/{{$course->slug}}"
                                               class="text-base font-semibold capitalize"> {{ $course->course_name }}
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
                ...
                @elseif(sizeof($course) > 0 && $category == 0)
                    <div class="lg:w-2/3 w-full">
                        <div uk-sticky="media @m ; offset:80 ; bottom : true" class="card">
            ...
            <div class="lg:flex lg:space-x-10 mt-3">
                <!-- Not found -->
                @if ($search == '' || sizeof(array($posts)) == 0 && sizeof(array($friend)) == 0 && sizeof(array($course)) == 0 || $posts->isEmpty() && $friend->isEmpty() && $course->isEmpty())
                    <div class="lg:w-2/3 w-full">
                        <div class="border-b flex items-center justify-between p-4">
                            <div>
                    ...
                    <div class="lg:w-2/3 w-full">
                        <div uk-sticky="media @m ; offset:80 ; bottom : true" class="card">
                            ...
                            <div class="border-b flex items-center justify-between p-4">
                                ...
                                <a href="/friends" class="text-blue-500"> Xem thêm </a>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                @foreach ($friend as $friend)
                                    <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                        <a href="{{route('profile',['id' => $friend->user_id])}}" href="timeline-page.html"iv
                ...
                @elseif(sizeof($friend) > 0 && $category == 0)
                    <div class="lg:w-2/3 w-full">
                        <div uk-sticky="media @m ; offset:80 ; bottom : true" class="card">
                                ...
                                @foreach ($friend as $friends)
                                    <div class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50">
                                        <a href="{{route('profile',['id' => $friends->user_id])}}" href="timeline-page.html"iv
                                           class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                            {{--                                            <img src="assets/images/avatars/avatar-1.jpg" class="absolute w-full h-full inset-0 " alt=""> --}}
                                            {!! getAvatar($friends->user_id) !!}
                                        </a>
                                        <div class="flex-1">
                                            <a href="{{route('profile',['id' => $friends->user_id])}}"
                                               class="text-base font-semibold capitalize"> {{ $friends->user_fullname }}
                                            </a>
                                        </div>
                                        @livewire('Clients.Friends.AddFriend', ['friendData' => $friends], key($friends->user_id))
            ...
            @if(array($posts) > 0 && $category == 1)
                <div class="lg:w-2/3 w-full ">
                    @foreach ($posts as $post)
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small mt-3"
                             @if ($loop->last) id="last-record" @endif>
                            <!-- post header-->
                            <div class="flex justify-between items-center lg:p-4 p-2.5">
                                <div class="flex flex-1 items-center space-x-4">
                                    <a href="{{route('profile',['id' => $post->user->user_id])}}">
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex items-center space-x-3 pt-2">
                                    ...
                                    <div class="dark:text-gray-100">
                                        ...
                                        @else
                                            ...
                                            @if ($post->reaction_count > 0 && $post->reaction[0]->user_id == auth()->user()->user_id)
                                                {{-- Nếu bạn đã thích bài viết, hiển thị thông báo --}}
                                                Bạn và {{ $post->reaction_like_count - 1 }} người khác đã thích bài
                                                viết này.
                                            @else
                                                {{-- Nếu không phải bạn thích, hiển thị thông báo cho người khác --}}
                                                {{ $post->reaction_like_count }} người đã thích bài viết này.
                                        ...
                                        <div class="flex">
                                            ...
                                            <div>
                                                <div class="text-gray-700 py-2 px-3 rounded-md bg-gray-100 relative lg:ml-5 ml-2 lg:mr-12 dark:bg-gray-800 dark:text-gray-100">
                                                    <a href="{{ route('profile',['id' => $post->user->user_id]) }}">{{ $comment->user_fullname }}</a>
                                ...
                                <div class="bg-gray-100 rounded-full relative dark:bg-gray-800 border-t">
                                    <form wire:submit="Insertcomment({{ $post->post_id }})">
                                        <input placeholder="Thêm bình luận của bạn"
            ...
            @elseif($category == 0 && count(array($search)) > 0)
                <div class="lg:w-2/3 w-full mt-3">
                    @foreach ($posts as $post)
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small mt-3"
                             @if ($loop->last) id="last-record" @endif>
                            <!-- post header-->
