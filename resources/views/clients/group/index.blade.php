                ...
                <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-grid-small uk-grid">
                    ...
                    <li>
                        <div class="card">
                            <div class="card-media h-28">
                                <div class="card-media-overly"></div>
                                <img src={{asset('clients/assets/images/group/group-cover-2.jpg')}} alt="" class="">
                            </div>
                            <div class="card-body">
                                ...
                                <div class="flex mt-3.5 space-x-2">
                                    <div class="flex items-center -space-x-2 -mt-1">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-3.jpg')}} class="border-2 border-white rounded-full w-7">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-5.jpg')}} class="border-2 border-white rounded-full w-7">
                                    </div>
                                    <div class="flex-1 leading-5 text-sm">
                    ...
                    <li>
                        <div class="card">
                            <div class="card-media h-28">
                                <div class="card-media-overly"></div>
                                <img src={{asset('clients/assets/images/events/img-2.jpg')}} alt="" class="">
                            </div>
                            <div class="card-body">
                                ...
                                <div class="flex mt-3.5 space-x-2">
                                    <div class="flex items-center -space-x-2 -mt-1">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-2.jpg')}} class="border-2 border-white rounded-full w-7">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-1.jpg')}} class="border-2 border-white rounded-full w-7">
                                    </div>
                                    <div class="flex-1 leading-5 text-sm">
                    ...
                    <li>
                        <div class="card">
                            <div class="card-media h-28">
                                <div class="card-media-overly"></div>
                                <img src={{asset('clients/assets/images/group/group-cover-3.jpg')}} alt="" class="">
                            </div>
                            <div class="card-body">
                                ...
                                <div class="flex mt-3.5 space-x-2">
                                    <div class="flex items-center -space-x-2 -mt-1">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-4.jpg')}} class="border-2 border-white rounded-full w-7">
                                        <img alt="Image placeholder" src={{asset('clients/assets/images/avatars/avatar-3.jpg')}} class="border-2 border-white rounded-full w-7">
                                    </div>
                                    <div class="flex-1 leading-5 text-sm">
                    ...
                    <li>
                        <div class="card">
                            <div class="card-media h-28">
                                <div class="card-media-overly"></div>
                                <img src={{asset('clients/assets/images/group/group-cover-4.jpg')}} alt="" class="">
                            </div>
                            <div class="card-body">
                ...
                <ul class="uk-slider-items uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid">
                    ...
                    <li>
                        <div class="rounded-md overflow-hidden relative w-full h-36">
                            ...
                            <img src={{asset('clients/assets/images/category/travel.jpg')}} class="absolute w-full h-full object-cover" alt="">
                    ...
                    <li>
                        <div class="rounded-md overflow-hidden relative w-full h-36">
                            ...
                            <img src={{asset('clients/assets/images/category/business.jpg')}} class="absolute w-full h-full object-cover" alt="">
                    ...
                    <li>
                        <div class="rounded-md overflow-hidden relative w-full h-36">
                            ...
                            <img src={{asset('clients/assets/images/category/health.jpg')}} class="absolute w-full h-full object-cover" alt="">
                    ...
                    <li>
                        <div class="rounded-md overflow-hidden relative w-full h-36">
                            ...
                            <img src={{asset('clients/assets/images/category/science-and-tech.jpg')}} class="absolute w-full h-full object-cover"
                                alt="">
                    ...
                    <li>
                        <div class="rounded-md overflow-hidden relative w-full h-36">
                            ...
                            <img src={{asset('clients/assets/images/category/Buy-and-sell.jpg')}} class="absolute w-full h-full object-cover"
                                alt="">
                ...
                <div class="grid md:grid-cols-2 divide divide-gray-200 gap-x-4 mt-4">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/group/group-3.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/group/group-4.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/group/group-2.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/group/group-5.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/group/group-1.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 py-3 hover:bg-gray-100 rounded-md -mx-2 px-2">
                        <div class="w-14 h-14 flex-shrink-0 rounded-md relative">
                            <img src={{asset('clients/assets/images/events/img-2.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover" alt="">
                        </div>
                        <div class="flex-1">
        ...
        <div class="grid md:grid-cols-2 divide divide-gray-200 gap-x-6 gap-y-4">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-4.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
                    ...
                    <div class="flex items-center mt-2">
                        <img src={{asset('clients/assets/images/avatars/avatar-2.jpg')}} class="w-6 rounded-full border-2 border-gray-200 -mr-2" alt="">
                        <img src={{asset('clients/assets/images/avatars/avatar-4.jpg')}} class="w-6 rounded-full border-2 border-gray-200" alt="">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-5.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-3.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
                    <a href="timeline-group.html"  class="text-lg font-semibold capitalize"> Graphic Design </a>
                    <div class="flex space-x-2 items-center text-sm">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-2.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
                    <a href="timeline-group.html"  class="text-lg font-semibold capitalize"> Coffee Addicts </a>
                    <div class="flex space-x-2 items-center text-sm">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-1.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
                    <a href="timeline-group.html"  class="text-lg font-semibold capitalize">  Property Rent And Sale </a>
                    <div class="flex space-x-2 items-center text-sm">
            ...
            <div class="flex items-center space-x-4">
                <div class="w-20 h-20 flex-shrink-0 rounded-md relative mb-3">
                    <img src={{asset('clients/assets/images/group/group-cover-3.jpg')}} class="absolute w-full h-full inset-0 rounded-md object-cover shadow-sm" alt="">
                </div>
                <div class="flex-1 border-b pb-3">
                    <a href="timeline-group.html"  class="text-lg font-semibold capitalize"> Architecture </a>
                    <div class="flex space-x-2 items-center text-sm">
