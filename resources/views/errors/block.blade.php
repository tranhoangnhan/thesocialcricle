...
@section('content')
    <div class="lg:p-12 max-w-5xl lg:my-0 my-12 mx-auto p-6 space-y- w-full flex flex-col">
        <div class="lg:p-12 p-7 space-y-3 relative bg-white shadow-xl rounded-md w-100 text-center relative">
            ...
            <div id="error-message" class="text-6xl font-bold text-blue-600">Bị chặn!</div>
            @if($block->user_id == auth()->user()->user_id)
            <p class="text-xl text-gray-600" id="message">Bạn đã chặn tài khoản này. Vui lòng quay lại sau.</p>
            @else
            <p class="text-xl text-gray-600" id="message">Tài khoản này đã chặn bạn. Vui lòng quay lại sau.</p>
            @endif
