...
@endsection
@section('content')
    <div class="lg:p-12 max-w-5xl lg:my-0 my-12 mx-auto p-6 space-y- w-full flex flex-col" id="mainError">
        <div class="lg:p-12 p-7 space-y-3 relative bg-white shadow-xl rounded-md w-100 text-center relative">
            ...
            <div id="error-message" class="text-6xl font-bold text-blue-600">500</div>
            <p class="text-xl text-gray-600" id="message">Máy chủ đang gặp 1 số trục trặc!</p>
            ...
            <img src="{{ asset('clients/assets/images/error/500_1.png') }}" class="m-auto w-60 md:absolute top-0 right-0"
                id="image">
            ...
            <img src="https://cdn.pixabay.com/photo/2012/05/04/12/56/insect-47381_1280.png" id="bug" class="w-5">
            <img src="https://cdn.pixabay.com/photo/2012/05/04/12/56/insect-47381_1280.png" id="bug" class="w-5 absolute right-5 bottom-2 transform rotate-180 scale-x-[-1]">
