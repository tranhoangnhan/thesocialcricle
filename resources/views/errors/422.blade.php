...
@section('content')
    <div class="lg:p-12 max-w-5xl lg:my-0 my-12 mx-auto p-6 space-y- w-full flex flex-col">
        <div class="lg:p-12 p-7 space-y-3 relative bg-white shadow-xl rounded-md w-100 text-center relative">
            ...
            <div id="error-message" class="text-6xl font-bold text-blue-600">422</div>
            <p class="text-xl text-gray-600" id="message">Dữ liệu không hợp lệ.</p>
            ...
            <img src="{{ asset('clients/assets/images/error/422.png') }}" class="m-auto w-60 md:absolute top-0 right-0"
                id="image">
